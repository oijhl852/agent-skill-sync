---
name: sd-panel
description: Seedance 浏览器面板连接 — Chrome DevTools MCP 连接、元素定位、工具可用性检测。由 seedance-storyboard 主 skill 调用。
metadata:
  version: "1.1.1"
...
> 作者：Takis | 仓库：[seedance-storyboard](https://github.com/oijhl852/seedance-storyboard)
...
仓库：https://github.com/oijhl852/seedance-storyboard
